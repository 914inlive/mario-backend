...
<script>
  import commonTree from '@/components/Other/CommonTree.vue'
      ...
      menuComponent() {
        ...
        if (this.menu.path && this.menu.path !== '/') {
          ...
          if (isUrl) {
            ...
            // comp = `前端组件：src/views/${this.menu.path}/Index.vue`
            comp = `组件路径：src/views/${this.menu.component}.vue`
          }
        } else {
          comp = `组件路径：src/views/Index.vue`
        }
        return comp
      }
    },
    ...
    methods: {
      ...
      computedComponent() {
        ...
        if (isUrl) {
          ...
          if (this.menu.path) {
            this.menu.component = `Other${this.menu.path}/Index`
          } else {
            this.menu.component = `Other/Index`
          }
        }
      },
      initMenuTree() {
