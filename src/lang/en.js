export default {
  ...
  commonTxt: {
    ...
    reload: 'Reload',
    noSelected: 'No common text is selected',
    noCategorySelected: 'No category is selected',
  },
  navbar: {
    setting: 'Settings',
    github: 'Repository',
  ...
  options: {
    greeting: {
      csTipTitle: 'Customer system tips',
      csOnlineTip: 'Customer Online Tips',
      csOfflineTip: 'Customer Offline Tips',
  ...
  table: {
    ...
    station: {
      ...
      id: 'Station Id',
      name: 'Station Name',
      createdTime: 'Station Create Time',
    },
    optLog: {
      requestIp: 'IP',
      type: 'type',
  ...
  sidebar: {
    ...
    user: 'User',
    register: 'Register',
    visitorList: 'Online Visitor',
    options: 'Options',
    greetingTips: 'Greeting Tips',
  ...
  tips: {
    ...
    iframeGrant: 'Userame: admin Password: admin',
    ...
    onlySupportImage: 'Upload failed, Only supports Image type files',
    updating: 'Updating',
  ...
  common: {
    system: 'LiveChat System',
    messageSound: 'Message Sound',
    desc: {
      a: 'This is a massage',
      b: 'Or some image here',
      c: 'Login exampl',
      d: 'say someting 1,2,3,4,5,6,7',
      e: 'say someting hello',
      f: 'say someting world',
    },
    view: 'Detail',
    tips: 'Tips',
    clear: 'Clear',
